...
library(plyr)
# generated 50 values from uniformely generated data and the range of uniformely generated data is 0 to 1
...
# k = 3 is the best k value , there is more drop here
